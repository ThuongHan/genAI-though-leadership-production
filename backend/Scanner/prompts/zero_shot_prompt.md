# KickstartAI Article Scoring - Zero-Shot Prompt

**Strategy:** zero_shot

**What the model does:** The model receives the scoring rubric and one article, with no examples. Baseline strategy: simplest and cheapest, one call per article.
